...
const char * ssid = "Mmm";//Change your wifi name
const char * password = "11221122";//Change your wifi password
...
void setup() {
 ...
 //display 
 if(!display.begin(0x3C, true)) { // Address 0x3C for 128x64 and reset not needed
    Serial.println(F("SH   allocation failed"));
    for(;;);
  }
